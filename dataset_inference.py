...
#chat_message = chat_message+"<|end_of_text|>"
    '''
    print("##################")
...
#trained_model = AutoModelForCausalLM.from_pretrained(origin_model_path, device_map="auto", torch_dtype=torch.float16)
